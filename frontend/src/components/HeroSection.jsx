      ...
      >
        <div className="max-w-3xl animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Your Dream Beachfront Stay
          </h1>
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Experience luxury living by the sea with modern apartments, world-class amenities, and unforgettable views.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/booking"
              className="px-6 py-3 min-w-[200px] rounded-full bg-primary text-white text-lg font-semibold hover:opacity-90 transition"
            >
              Book Your Stay
            </Link>
            <Link
              to="/apartments"
              className="px-6 py-3 min-w-[200px] rounded-full border border-white text-white text-lg font-semibold hover:bg-white hover:text-black transition"
            >
              Explore Apartments
            </Link>
          </div>
